...
description: ""
socialDescription: ""
mmShort: How MNKY Math is organized as a digital garden, including Explorer, Graph View, backlinks, previews, directories, and ways to wander without getting lost.
tags: []
date: 2026-05-30
...
You can start with a story, follow a concept, view or open a definition, preview a related idea, return through backlinks, or use the graph view to see how ideas cluster. Moving about with this type of relational freedom is what we call [[def_exploratory-navigation|exploratory navigation]].
...
> [!info] 
> 🖥️ The Explorer is presented in the left-side panel. <br>
📱 On mobile devices the Explorer becomes the hamburger in the top-left corner.<br><br>

☝️Use Explorer when you want a more structured path through the garden. It is especially helpful when you want to see what lives under major areas like [[about/index|About]], [[archive/index|Archive]], [[foundations/index|Foundations]], [[tools/index|Tools]], or [[neighborhood/index|The Neighborhood]].
...
> [!info]
> 🖥️ Graph View lives in the right-side panel at the top.<br>
> 📱 On mobile browsers, Graph View moves to the bottom of the page.<br><br>
...
> [!info] 
>🖥️ Backlinks are in the right-side panel at the bottom.<br>
📱 On mobile browsers, Backlinks move to the bottom of the page.<br><br>
...
Backlinks help answer a useful question: _Where else does this idea show up?_
...
> [!info]
> 🖥️ On a PC, hovering over a link may show a small preview of the linked page.<br>
> 📱 On mobile devices, previews may appear through a press-and-hold interaction and then selecting "preview" from an options list depending on your device and browser.<br><br>
...
> [!info]
> 🖥️ Search is located in the left-side panel under the MNKY Math logo.<br>
> 📱 On mobile devices, Search is in the top band.<br><br>
...
><span style="--emoji: '  '; font-family: var(--codeFont); color: var(--darkgraymm); font-size: 0.85rem;">> about > how mnky math works > exploring the garden</span>
...
If an idea feels abstract, start with an essay or example. You will find all of these within the [[archive/index|Archive]].
...
#### Check backlinks when something feels important
...
If wandering starts to feel too loose, return to the [[content/archive/index|Archive]] or [[content/foundations/index|Foundations]].

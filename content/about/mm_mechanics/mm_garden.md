...
You can start with a story, follow a concept, open a definition, preview a related idea, return through backlinks, or use the graph to see how ideas cluster.
...
The local graph lives in the upper-right side panel.  
...
Use the local graph when you want to see the immediate neighborhood around the page you are reading.  
  
#### Global Graph View  
  
The global graph can be opened by clicking the graph icon in the top-right area of the local graph.  
...
- You can zoom in and out in either graph view. Zooming in will begin to reveal names. 
...
Many links in MNKY Math can be previewed before you fully open them.

On desktop, hovering over a link may show a small preview of the linked page.

On mobile, previews may appear through a tap or press interaction depending on your device and browser.
...
This directory is hidden from Explorer. The pages contained within this directory are accessible through links from other pages. This helps make the garden easier to read by supporting this type of side-bar content without muddying core content pathways. 

...
description: ""
socialDescription: ""
mmShort: The act of translating something observed into a number, category, score, signal, or record that can be compared, evaluated, tracked, or used in decisions.
tags: []
date: 2026-06-04
...
A [[def_composite-metric|composite metric]] is a special type of measurement that combines multiple measurements into a single signal. Composite metrics can be useful because they simplify complexity. But they can also hide important differences between the parts being combined.
...
In MNKY Math, _measurement_ matters because it often becomes part of the system it was meant to observe.  
...
But also: **_==What did measurement change?==_**

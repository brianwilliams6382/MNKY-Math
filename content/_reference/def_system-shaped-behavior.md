...
description: ""
socialDescription: ""
mmShort: Behavior that is influenced by the incentives, constraints, signals, defaults, pressures, and feedback loops of the system surrounding it.
tags: []
date: 2026-06-04
...
It also asks:  **_==What did the system make easy, safe, rewarded, costly, rational, or normal?==_**
  
System-shaped behavior is especially important when many people respond in similar ways.  
  
> [!info]When behavior repeats across a system, the pattern may say as much about the system as it says about the individuals inside it.
...
readerMode:
  - mastering
fm_level:
description: Goodhart’s Law explains why measures can lose meaning when they become targets. MNKY Math extends this into systems, behavior, and outcomes.
socialDescription: When the measure becomes the target, the system starts learning the wrong thing.
mmShort: Goodhart’s Law is a close neighbor that explains why measures can lose meaning once systems begin optimizing around them.
tags:
date: 2025-12-01
...
The idea is usually attributed to British economist Charles Goodhart, who expressed the core insight in the context of monetary policy: once pressure is placed on a statistical regularity for control purposes, the regularity tends to break down. Later writers generalized the idea into the better-known wording about _measures becoming targets_.

> [!info] **In plain language: when people know a number matters, they begin responding to the number.**
...
4. **_Then behavior starts changing around the pressure._**

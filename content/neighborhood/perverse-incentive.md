...
description: ""
socialDescription: ""
mmShort: A perverse incentive is a reward or pressure that encourages behavior opposite to the intended outcome.
tags: []
date: 2025-12-01
...
> [!info] **In plain language: a perverse incentive is when the system rewards the behavior that makes the real problem worse.**
...
> **_What did the system make rational?_**  
> **_What behavior became easier to defend?_**  
> **_What signal replaced the intended outcome?_**  
> **_Who absorbed the hidden cost?_**  
> **_What did the system begin teaching people to repeat?_**  
> **_What outcome became more likely because the incentive existed?_**
...
- A sales team may be rewarded for activity volume and begin producing more calls, emails, or meetings without improving customer fit, trust, or revenue quality.<br><br>
- A customer-service team may be rewarded for shorter handling times and begin moving faster while leaving customers less understood, less helped, or less resolved.<br><br>
- A school may reward test-score improvement and unintentionally narrow learning toward what is easiest to test.<br><br>
- A workplace may reward issue closure and teach teams to close tickets instead of solving root causes.<br><br>
- A healthcare system may reward throughput and create pressure to move patients quickly while shifting hidden burdens onto staff, patients, or downstream care.<br><br>
- A company may reward cost reduction and unintentionally push costs onto customers, employees, future maintenance, or another part of the system.<br><br>
- A platform may reward engagement and teach creators to produce outrage, repetition, simplification, or emotional escalation rather than meaning, accuracy, or care.<br><br>
...
<span class="mm-label" style="color: var(--gray);">**_Closest twin:_**</span> [[cobra-effect|Cobra Effect]] 
<span class="mm-reduced">Both describe incentives that produce unintended harm, but the Cobra Effect emphasizes the backfire pattern where the attempted fix makes the original problem worse.</span>

<span class="mm-label" style="color: var(--gray);">**_Clarifying contrast:_**</span> [[goodharts-law|Goodhart's Law]] 
<span class="mm-reduced">Goodhart’s Law focuses on measures becoming targets; perverse incentive focuses on rewards or pressures that make the wrong behavior worth doing.</span>

<span class="mm-label" style="color: var(--gray);">**_Mostly shaped by:_**</span> [[def_incentive|Incentives]] 
<span class="mm-reduced">Incentives shape systems and behavior. A perverse incentive is a type of incentive that occurs when the system rewards, protects, or pressures behavior that works against the intended outcome.</span>

<span class="mm-label" style="color: var(--gray);">**_Helps explain:_**</span> [[def_system-shaped-behavior|System-shaped Behavior]] 
<span class="mm-reduced">It shows how behavior that looks irrational from outside the system can become rational from inside the incentive structure.</span>

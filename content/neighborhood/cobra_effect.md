...
The Cobra Effect is closely related to several other neighbors in The Neighborhood.

A simple way to distinguish them:

- **[[goodharts_law|Goodhart’s Law]]** asks what happens when a measure becomes a target.
- **[[campbells_law|Campbell’s Law]]** asks what happens when indicators become tools for social decision-making and control.
- **Cobra Effect** asks what happens when an incentive makes the problem worse.
- **Perverse Incentive** names the broader category of incentives that reward harmful, unwanted, or misaligned behavior.

Together, these neighbors help explain how systems can appear to be solving a problem while teaching people to reproduce it.

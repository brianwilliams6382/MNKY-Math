...
readerMode:
  - mirroring
fm_level:
description: MNKY Math is a public knowledge framework for making visible how systems shape behavior, influence outcomes, and affect human agency.
socialDescription: ""
tags: []
date: 2025-10-01
last_reviewed:
...
![[/static/muscial_chairs.webp]]


It feels like a game of timing, speed, and luck.

But it is also a [[_reference/def_system|system]].
...
The same structure shows up in less obvious systems: hiring, budget cycles, dashboards, performance reviews, customer queues, pricing models, advertising, and workplace policies — 
along with almost anything else you can think to name, **_==and many things you might not yet think of as systems.==_**
...
> [!quote] Once you see how a simple game can shape behavior, it becomes harder not to ask what the larger systems around us are teaching too.
